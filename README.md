...
- Worktree tags — Assign labels via the command palette and separate multiple tags with commas (e.g. "bug,frontend,urgent"); tags display as coloured badges after the worktree name and are included in filter/search matching
