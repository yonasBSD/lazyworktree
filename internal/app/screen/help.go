...
- Command palette: Set worktree tags — comma-separated labels (e.g. "bug,frontend,urgent") displayed as coloured badges after the worktree name; tags are searchable and filterable
